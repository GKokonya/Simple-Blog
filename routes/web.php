...
Route::prefix('admin')->name('admin.')->group(function(){
    ############################ ROLES #############################
    Route::group(['middleware'=>['can:view all roles']],function(){
    ...
    ############################ PERMISSIONS #############################
    Route::group(['middleware'=>['can:view all permissions']],function(){
    ...
    ########################### POSTS ########################
    Route::group(['middleware'=>['can:view all posts']],function(){
        Route::resource('/posts', PostController::class);
    });
    ########################### USERS ########################
    Route::group(['middleware'=>['can:view all users']],function(){
